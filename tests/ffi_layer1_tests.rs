...
use opus_ffi::*;
use opus_wave::silk::encoder_flp::find_ltp::silk_ltp_analysis_filter_flp;
use opus_wave::silk::gain_quant;
use opus_wave::silk::nlsf;
use opus_wave::silk::*;
...
fn encode_indices_pulses_decodable_by_c() {
    ...
    use opus_wave::{Application, Bitrate, Channels, OpusEncoder, SampleRate};
...
fn c_encoder_output_decodable_by_rust() {
    ...
    use opus_wave::{Channels, OpusDecoder, SampleRate};
